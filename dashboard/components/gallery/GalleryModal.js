...
const DeleteModal = ({ isOpen, gallery, onClose, onConfirm, loading }) => {
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6">
        <div className="text-center mb-6">
          ...
          <h3 className="text-2xl font-bold text-slate-800 mb-2">Delete gallery?</h3>
          <p className="text-slate-600">
            Are you sure you want to delete <span className="font-semibold">"{gallery?.title}"</span>? This action cannot be undone.
          </p>
        </div>
